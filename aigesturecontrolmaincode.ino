...
const char* ssid = "YOUR_WIFI_NETWORK";   // The name of the WiFi network you want to connect to
const char* password = "YOUR_WIFI_PASSWORD";  // The password of the WiFi network
