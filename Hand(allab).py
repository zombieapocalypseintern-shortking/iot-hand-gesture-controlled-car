    ...
    if results.multi_hand_landmarks:
        for hand_landmarks in results.multi_hand_landmarks:
            ...
            if dist_thumb_index < 0 and dist_index_middle < 0 and dist_middle_pinky < 0:
                ...
                cv2.putText(frame, f"Rotation Angle: {angle:.2f}", (50, 50), cv2.FONT_HERSHEY_SIMPLEX, 0.7,
                ...
                if (top_box_top_left[0] < landmarks[9][0] < top_box_bottom_right[0] and
                    ...
                    # Display rotation angle on the left side of the screen
                    cv2.putText(frame, f"Forward", (50, 100), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (255, 255, 255), 2,
                                cv2.LINE_AA)
                    sendTorobot("f")
                    print("Forward")
                    ...
                    cv2.putText(frame, f"Back", (50, 100), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (255, 255, 255), 2,
                                cv2.LINE_AA)
                    sendTorobot("b")
                    print("Back")
                elif turn != True:
                    cv2.putText(frame, f"Stop", (50, 100), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (255, 255, 255), 2,
                                cv2.LINE_AA)
                    sendTorobot("s")
                    print("Stop")

            # Display the label on the frame after flipping
            cv2.putText(frame, hand_label, (landmarks[0][0], landmarks[0][1]), cv2.FONT_HERSHEY_SIMPLEX, 0.7,
                        (255, 255, 255), 2, cv2.LINE_AA)
